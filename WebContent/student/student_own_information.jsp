...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="${pageContext.request.contextPath}/yy/student/update_info" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control update" id="classname"  name="classname" readonly="true" value="${sessionScope.admin.classname }">
				</div>
