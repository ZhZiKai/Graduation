...
public interface TeacherDao {
	...
	public int updateTpaper(@Param("state")String state, @Param("pid")String pid);
	...
	public List<Student> getGroupStudent(@Param("gid")String gid, @Param("sdid")String sdid, @Param("tid")String tid);

	public int commitScore(SpScore one);

	public int saveAvg(@Param("psid")String psid);
}
